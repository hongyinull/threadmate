...
(() => {
  ...
  // Composer selector — prefer the role=textbox / Lexical editor before the bare
  // contenteditable.
  const COMPOSER_SEL =
  ...
  function guessPostText(editor) {
    ...
    // Threads — primary anchor: the post container.
  ...
  // is the canonical Lexical listener and fixes the
  ...
  // ---- auto-engagement engine (feature 7) --------------------------------
  // Conservative caps + random pacing + kill switch + local log.
